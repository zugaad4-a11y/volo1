    ...
    return (
        <div className="space-y-8 max-w-3xl mx-auto">
            ...
            <div className="text-center space-y-3">
                ...
                <h1 className="text-3xl font-bold tracking-tight text-white">Refer a Partner, Earn Rewards</h1>
                <p className="text-slate-400 max-w-lg mx-auto">
                    Know someone who wants to work as a VOLO partner? Refer them and earn{' '}
                    <span className="text-emerald-400 font-bold">₹{settings.referrer_reward}</span>{' '}
                    once they complete their first {settings.min_bookings_to_qualify} job(s).
                </p>
            </div>
            ...
            <div className="bg-[#0F172A] border border-white/[0.08] rounded-3xl p-8 shadow-sm">
                <div className="max-w-md mx-auto space-y-6">
                    <div className="space-y-2">
                        <label className="text-[10px] font-extrabold uppercase text-slate-400 tracking-wider">Your Unique Partner Referral Link</label>
                        {code ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-[#0F172A] border border-white/[0.08] rounded-2xl p-6 text-center">
                    ...
                    <p className="text-[10px] text-slate-600 mt-2">{stats.pendingCount} awaiting jobs</p>
                </div>
                <div className="bg-[#0F172A] border border-white/[0.08] rounded-2xl p-6 text-center">
                        ...
                        {referrals.map((ref: any) => (
                            <div key={ref.id} className="px-5 py-3 flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-xs font-bold text-white">New Partner Referred</p>
            ...
            {referrals.length === 0 && (
                <div className="bg-[#0F172A] border border-white/[0.06] rounded-2xl py-10 flex flex-col items-center gap-3">
                    ...
                    <p className="text-[10px] text-slate-600">Share your link to start earning when your referrals complete jobs!</p>
                </div>
            )}
            ...
            <div className="pt-4">
                ...
                <div className="flex flex-col md:flex-row gap-6 justify-center">
                    <div className="flex-1 text-center space-y-2">
                        ...
                        <p className="text-xs text-slate-500">Send your referral link to potential partners</p>
                    </div>
                    <div className="flex-1 text-center space-y-2">
                        ...
                        <h4 className="font-bold text-sm text-white">They Join & Get Approved</h4>
                        <p className="text-xs text-slate-500">They sign up, complete KYC and start working</p>
                    </div>
                    <div className="flex-1 text-center space-y-2">
                        ...
                        <p className="text-xs text-slate-500">Get ₹{settings.referrer_reward} after {settings.min_bookings_to_qualify} completed job(s)</p>
                    </div>
                </div>
            </div>
        </div>
